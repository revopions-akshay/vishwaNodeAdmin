...
// const AddProducts = React.lazy(() => import('./views/buttons/button-groups/ButtonGroups'))
// const AddProduct = React.lazy(() => import('./views/buttons/dropdowns/Dropdowns'))

// Brands
const Brands = React.lazy(() => import('./views/brand/Brand'))
...
const routes = [
  ...
  { path: '/brand', name: 'Brands', element: Brands, exact: true },
  { path: '/addbrand', name: 'AddBrand', element: AddBrand, exact: true },
  { path: '/brand/update/:id', name: 'UpdateBrand', element: UpdateBrand, exact: true },
  { path: '/media', name: 'Media', element: Media, exact: true },
  { path: '/category', name: 'Category', element: Category, exact: true },
  { path: '/addcategory', name: 'Add Category', element: addCategory, exact: true },
  { path: '/category/update/:id', name: 'Update Category', element: updateCategory, exact: true },
  { path: '/product', name: 'Product', element: Products, exact: true },
  { path: '/product/add', name: 'AddProduct', element: AddProduct, exact: true },
